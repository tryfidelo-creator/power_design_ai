...
export const DesignerDashboard: React.FC<DesignerDashboardProps> = ({ onBack }) => {
  ...
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen bg-substrate grid-overlay p-6 font-sans selection:bg-high-voltage/30"
    >
      {/* Header */}
      <header className="flex justify-between items-center mb-8 border-b border-high-voltage/20 pb-4">
        <div className="flex items-center gap-6">
          <button 
            onClick={onBack}
            className="p-2 hover:bg-white/5 transition-colors faraday-cage group flex items-center gap-2 text-[10px] font-mono text-white/40 uppercase"
          >
